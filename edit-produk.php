...
<head>
    ...
    <title>Edit Produk - E-SMART</title>
        ...
        <div class="container">
            ...
            <div class="box">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="number" name="stok" placeholder="Jumlah Stok" class="input-control" value="<?php echo $p->product_stock ?>" required>
                    
                    <img src="produk/<?php echo $p->product_image ?>" width="100px" style="margin-top: 10px;">
                ...
                <?php 
                    if(isset($_POST['submit'])){
                        ...
                        // 1. Ambil data inputan (DIPERBAIKI: Variabel $stok ditambahkan)
                        $kategori   = $_POST['kategori'];
                        $nama       = $_POST['nama'];
                        $harga      = $_POST['harga'];
                        $stok       = $_POST['stok']; // Ini yang tadinya belum ada
